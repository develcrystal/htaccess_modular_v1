...
from tkinter import ttk  # Importiere ttk für die Progressbar
...
class HTAccessOptimizerGUI:
    ...
    def create_widgets(self):
        ...
        self.progress_bar = ttk.Progressbar(self.master, maximum=100)  # Verwende ttk.Progressbar
    ...
    def update_progress(self, value: float) -> None:
        self.progress_bar['value'] = value  # Aktualisiere den Fortschritt
