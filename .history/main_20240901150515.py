...
class HTAccessOptimizerGUI:
    ...
    def ask_for_base_url(self) -> str:
        # Use simpledialog to ask for the base URL
        base_url = simpledialog.askstring("Basis-URL", "Bitte geben Sie die Basis-URL Ihrer Website ein:")
        return base_url

    def ask_for_sitemap_url(self) -> str:
        # Use simpledialog to ask for the Sitemap URL
        sitemap_url = simpledialog.askstring("Sitemap-URL", "Bitte geben Sie die Sitemap-URL Ihrer Website ein:")
        return sitemap_url
