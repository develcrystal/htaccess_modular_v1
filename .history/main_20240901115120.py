...
from modules.scraper import scrape_urls  # Stelle sicher, dass dies importiert ist
...
class HTAccessOptimizerGUI:
    ...
    def start_process(self, htaccess_path, excel_path, sitemap_url, base_url):
        global paused
        ...
        for i, url in enumerate(urls_to_test):
            while paused:
                # Warten, bis die Verarbeitung fortgesetzt wird
                pass

            result, final_url = scrape_urls([url])[0]  # Stelle sicher, dass dies richtig importiert ist
            source = url_sources[i]

            # Hier kannst du das Ergebnis verarbeiten und in eine Logdatei schreiben
